...
//   const totalCards = 6;
//   const scrollDuration = 1.7; // Adjust duration for smoother transitions

//   const updateCardWidth = () => {
//     const viewportWidth = window.innerWidth;
//     if (viewportWidth <= 620) {
//       setCardWidth(viewportWidth); // One card should be fully visible
//     } else if (viewportWidth <= 1200) {
//       setCardWidth(viewportWidth / 5); // Five cards should be fully visible
//     } else {
//       setCardWidth((viewportWidth / 2) * 0.9); // Two cards visible with portions of others
//     }
//   };
...
//     const viewportWidth = window.innerWidth;
//     let visibleCards = 1; // Default to 1 card

//     if (viewportWidth > 620 && viewportWidth <= 1200) {
//       visibleCards = 5; // Five cards fully visible
//     } else if (viewportWidth > 1200) {
//       visibleCards = 2; // Two cards with portions of others
//     }
...
//     // Ensure the offset is constrained within the bounds
...
//     if (modalOpen) return; // Prevent scrolling if modal is open
//     event.preventDefault();
//     if (isScrolling) return; // Prevent multiple scroll events from firing in quick succession
...
//     // Reset isScrolling after a short delay to allow smooth scrolling
//     setTimeout(() => setIsScrolling(false), scrollDuration * 1000); // Adjust delay for smoother effect
//   };
...
//             transition: `transform ${scrollDuration}s ease`, // Adjusted duration for smoother transition
//           }}
//         >
